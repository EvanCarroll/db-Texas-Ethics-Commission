...
ALTER TABLE tec.c_FilerData
	...
	ADD FOREIGN KEY (filerStreetCountryCd) REFERENCES tec.codes_countries NOT VALID,
	ADD FOREIGN KEY (filerMailingCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (filerMailingCountryCd) REFERENCES tec.codes_countries NOT VALID,
	ADD FOREIGN KEY (filerHoldOfficeCd) REFERENCES tec.codes_offices NOT VALID,
	ADD FOREIGN KEY (filerHoldOfficeCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (contestSeekOfficeCd) REFERENCES tec.codes_offices NOT VALID,
	ADD FOREIGN KEY (contestSeekOfficeCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (treasNameSuffixCd) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (treasNamePrefixCd) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (treasStreetCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (treasStreetCountryCd) REFERENCES tec.codes_countries NOT VALID,
	ADD FOREIGN KEY (treasMailingCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (treasMailingCountryCd) REFERENCES tec.codes_countries NOT VALID,
	ADD FOREIGN KEY (assttreasNameSuffixCd) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (assttreasNamePrefixCd) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (assttreasStreetCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (assttreasStreetCountryCd) REFERENCES tec.codes_countries NOT VALID,
	ADD FOREIGN KEY (chairNameSuffixCd) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (chairNamePrefixCd) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (chairStreetCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (chairStreetCountryCd) REFERENCES tec.codes_countries NOT VALID,
	ADD FOREIGN KEY (chairMailingCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (chairMailingCountryCd) REFERENCES tec.codes_countries NOT VALID;
