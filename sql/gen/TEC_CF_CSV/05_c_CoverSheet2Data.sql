...
ALTER TABLE tec.c_CoverSheet2Data
	...
	ADD FOREIGN KEY (notifierNameSuffixCd) REFERENCES tec.codes_name_suffixes NOT VALID,
	ADD FOREIGN KEY (notifierNamePrefixCd) REFERENCES tec.codes_name_prefixes NOT VALID,
	ADD FOREIGN KEY (notifierStreetCountyCd) REFERENCES tec.codes_counties NOT VALID,
	ADD FOREIGN KEY (notifierStreetCountryCd) REFERENCES tec.codes_countries NOT VALID,
